...
distances = [
[0, 5.4 , 3.3 , 0.8 , 8.9 , 6.3 , 8.4 , 16.3 , 19.6 , 2.3 ],
[4.9 , 0, 7.7 , 5.8 , 4.9 , 6.2 , 5.0 , 31.8 , 33.1 , 4.3 ],
[3.5 , 8.1 , 0, 3.0 , 10.6 , 6.5 , 14.2 , 15.0 , 17.0 , 5.1 ],
[0.8 , 5.4 , 3.0 , 0, 9.1 , 6.5 , 8.7 , 16.0 , 19.3 , 2.3 ],
[8.8 , 4.9 , 10.6 , 9.9 , 0, 12.0 , 2.1 , 28.4 , 29.7 , 8.7 ],
[6.6 , 6.3 , 6.5 , 7.6 , 7.2 , 0, 6.3 , 21.9 , 23.2 , 7.3 ],
[8.2 , 5.0 , 18.9 , 9.4 , 2.0 , 11.3 , 0, 27.7 , 29.0 , 8.6 ],
[17.0 , 32.0 , 15.4 , 16.5 , 28.2 , 21.5 , 27.4 , 0, 23.8 , 18.5 ],
[19.8 , 33.5 , 16.9 , 19.3 , 29.7 , 23.0 , 28.9 , 23.6 , 0, 21.3 ],
[1.8 , 4.4 , 5.1 , 2.6 , 8.9 , 7.3 , 9.0 , 18.1 , 21.4 , 0],
]
ratings = []

with open('Kaohsiung_Tourist_2.csv', newline='', encoding='utf-8') as csvfile:
...
df = pd.read_csv('Yunlin_Tourist_1.csv')

for i in best_list_ex:
